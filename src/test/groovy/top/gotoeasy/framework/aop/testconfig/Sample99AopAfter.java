...
public class Sample99AopAfter {
    ...
    @After(value = "*.Sample99Bean.init()", annotations = Deprecated.class)
    public void after3(Enhance enhance, Method method) {
        log.warn("父类方法默认拦不到的");
    }

    @After(value = "*.Sample99Bean.init()", annotations = Deprecated.class, matchSuperMethod = true)
    public void after4(Enhance enhance) {
        log.debug("拦截父类方法要指定matchSuperMethod=true");
    }

    @After(value = "*.Sample99Bean.toString()", matchSuperMethod = true, matchToString = true, order = 1)
    public void after5(Method method) {
        log.debug("拦截toString()");
    }

    @After(value = "*.Sample99Bean.equals(java.lang.Object)", matchSuperMethod = true, matchEquals = true, order = 2)
    public void after6(Method method, AopContext aopContext, Object ... args) {
        log.debug("拦截equals(java.lang.Object)");
    }

    @After(value = "*.Sample99Bean.hashCode()", matchSuperMethod = true, matchHashCode = true, order = 3)
    ...
    @After(value = "*.Sample99Bean.add(*)", matchSuperMethod = true)
